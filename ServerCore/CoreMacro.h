...
#define READ_LOCK_IDX(idx)             \
	ReadLockGuard readLockGuard_##idx( \
		_locks[idx], typeid(this).name());	// ##idx�� idx�� ġȯ�� (readLockGuard_1, readLockGuard_2 ..)
#define READ_LOCK READ_LOCK_IDX(0)
#define WRITE_LOCK_IDX(idx)              \
	WriteLockGuard writeLockGuard_##idx( \
		_locks[idx], typeid(this).name());	// ##idx�� idx�� ġȯ�� (writeLockGuard_1, writeLockGuard_2 ..)
